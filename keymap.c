 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Mod3 |   C  |   T  |   I  |   E  |   O  |-------.    ,-------|   B  |   N  |   R  |   S  |   G  |  Q   |
 * |------+------+------+------+------+------|       |    | QWERT |------+------+------+------+------+------|
 * |LShift|   F  |   V  |   Ü  |   Ä  |   Ö  |-------|    |-------|   Y  |   Z  |   ,  |   .  |   k  |RShift|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | Mod4 | LAlt |LCtrl | /Space  /       \ Mod4 \  | RAlt | RCtrl| RGui |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_BONE2_1] = LAYOUT(
  ...
  MOD3,  KC_C,   KC_T,    KC_I,    KC_E,    KC_O,                           KC_B,    KC_N,     KC_R,    KC_S,    KC_G,    KC_Q,
  KC_LSFT,  KC_F,   KC_V,    KC_LBRC, KC_QUOT, KC_SCLN,  XXXXXXX,  TG(QWERTY), KC_Y,    KC_Z,     KC_COMM, KC_DOT,  KC_K,    KC_RSFT,
                      MOD4, KC_LALT, KC_LCTRL, KC_SPC,                   MOD4, KC_RALT, KC_RCTRL, KC_RGUI
),
 ...
 */
 ...
 [_BONE2_3] = LAYOUT(
  ...
  _______,  XXXXXXX, S(KC_SLSH), RALT(KC_8), RALT(KC_9),   KC_CIRC,                      KC_EXLM,  KC_NUBS,  S(KC_NUBS),  S(KC_0),  S(KC_6),   S(KC_EQL),
  XXXXXXX,  RALT(KC_MINS), S(KC_7),  KC_LCBR, KC_RCBR,   S(KC_RBRC),             S(KC_MINS), KC_LPRN, KC_RPRN,  KC_SLSH,  S(KC_DOT),  RALT(KC_L),
  XXXXXXX,  KC_NUHS,  S(KC_4), RALT(KC_NUBS), RALT(KC_ESC),  KC_EQL,  XXXXXXX,  XXXXXXX,  KC_RBRC,  S(KC_5), S(KC_2),  S(KC_NUHS),  S(KC_COMM),  XXXXXXX,
 ...
 */
 ...
 [_BONE2_4] = LAYOUT(
  KC_ESC,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       XXXXXXX,    KC_TAB, S(KC_7), S(KC_RBRC), XXXXXXX, XXXXXXX,
  XXXXXXX,  KC_PGUP, KC_BSPC, KC_UP,   KC_DEL,   KC_PGDN,                      XXXXXXX,  KC_P7,  KC_P8,   KC_P9,  KC_RBRC,     KC_SLSH,
  XXXXXXX,  KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT, KC_END,                       XXXXXXX,  KC_P4,  KC_P5,   KC_P6,  KC_COMM,     KC_DOT,
  XXXXXXX,  KC_ESC,  KC_TAB,  KC_INS,  KC_ENT,   XXXXXXX,  XXXXXXX,  XXXXXXX,  S(KC_DOT),  KC_P1,  KC_P2,   KC_P3,  S(KC_COMM),  XXXXXXX,
                                _______, _______, _______,  _______,                _______, _______, _______, _______
),
 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  _______,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
...
void oled_task_user(void) {
  ...
  //render_lily58_logo();
  /* TODO: add back when oled display supports bone layers & mods
